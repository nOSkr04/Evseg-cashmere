    ...
    <SafeAreaView style={styles.root}>
        ...
        <View style={styles.userContainer}>
          ...
          <View style={styles.userInfoContainer}>
            <BoldText
              numberOfLines={2}
              style={styles.name}
            >{`${data?.lastName} ${data?.firstName}`}</BoldText>
            <SemiBoldText style={styles.phone}>
              {data?.phone} ⭒ {(data?.point || 0).toLocaleString()} пойнт
            </SemiBoldText>
            <MediumText style={styles.loyalty}>
              Түвшин:{" "}
              <MediumText style={styles.loyaltyPercent}>
                {data?.loyaltyPercent}
              </MediumText>
            </MediumText>
          </View>
      ...
      <View>
        <View style={styles.socialContainer}>
          <TouchableOpacity
            onPress={() => {
              Linking.openURL("https://www.facebook.com/EvsegCashmere");
            }}
          >
            <AntDesign
          ...
          <TouchableOpacity
            onPress={() => {
              Linking.openURL("https://www.instagram.com/evsegcashmere");
            }}
          >
