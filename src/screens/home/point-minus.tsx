  ...
  const handleBarCodeScanned = useCallback(
    async ({ data }: { data: string }) => {
      ...
      try {
        ...
        navigation.navigate(NavigationRoutes.MinusPointScreen, { user });
        setScanned(false);
      } catch (err) {
        console.log(err);
...
PointMinusScreen.displayName = "PointMinusScreen";

export { PointMinusScreen };
