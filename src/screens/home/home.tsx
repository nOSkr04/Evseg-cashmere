...
const HomeScreen = memo(() => {
  ...
  const { data: user, isLoading } = useSWR(`swr.user.me.${refId}`, async () => {
    ...
    <>
      ...
      >
        ...
        <Animated.FlatList
          ...
          ListHeaderComponent={<ParallaxView isLoading={isLoading} shared={shared} user={user} />}
          data={data}
