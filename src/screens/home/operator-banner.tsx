...
const OperatorBanner = memo(() => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.navigate(NavigationRoutes.PointAccessScreen)} style={styles.card}>
        <AntDesign color={Colors.primary} name="plus" size={32} />
        <Text style={styles.title}>Оноо олгох</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate(NavigationRoutes.PointMinusScreen)} style={styles.card}>
        <AntDesign color={Colors.primary} name="minus" size={32} />
        <Text style={styles.title}>Оноо суутгах</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate(NavigationRoutes.UserSearchScreen)} style={styles.card}>
